...
OEMLabel		db "ROLFBOOT"	; Disk label
...
VolumeLabel		db "ROLFOS     "; Volume Label: any 11 chars
...
reboot:
  mov si, fatal_error_message		; If kernel is not found, bail out
  call print_string
	mov ax, 0
...
kern_filename	db "KERNEL  BIN"	; RolfOS kernel filename

disk_error	db "Floppy error!", 0
file_not_found	db "KERNEL not found!", 0
fatal_error_message	db "Fatal!", 0
