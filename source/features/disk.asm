...
os_disk_write_file:
	...
	call os_disk_file_exists		; Don't overwrite a file if it exists!
	jnc near .failure
...
.carry_on:
	...
	call os_disk_create_file		; Create empty root dir entry for this file
...
.read_fat_loop:
	...
	jnc .fat_done
	call os_disk_reset_floppy		; Reset controller and try again
